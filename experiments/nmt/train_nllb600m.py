...
p.add_argument("--out",type=str,default="runs/train_nllb600m")
...
a=p.parse_args()
cmd=[sys.executable,"experiments/nmt/train_generic.py","--csv",a.csv,"--out",a.out,"--model","facebook/nllb-200-distilled-600M","--src_code","eng_Latn","--tgt_code","vie_Latn","--epochs",str(a.epochs),"--lr",str(a.lr),"--warmup",str(a.warmup),"--grad_accum",str(a.grad_accum),"--train_bs",str(a.train_bs),"--eval_bs",str(a.eval_bs),"--max_src",str(a.max_src),"--max_new",str(a.max_new),"--patience",str(a.patience)]
