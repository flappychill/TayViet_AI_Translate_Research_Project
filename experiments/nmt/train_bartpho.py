...
p.add_argument("--out",type=str,default="runs/train_bartpho")
...
a=p.parse_args()
cmd=[sys.executable,"experiments/nmt/train_generic.py","--csv",a.csv,"--out",a.out,"--model","vinai/bartpho-syllable","--src_code","en_XX","--tgt_code","vi_VN","--epochs",str(a.epochs),"--lr",str(a.lr),"--warmup",str(a.warmup),"--grad_accum",str(a.grad_accum),"--train_bs",str(a.train_bs),"--eval_bs",str(a.eval_bs),"--max_src",str(a.max_src),"--max_new",str(a.max_new),"--patience",str(a.patience)]
